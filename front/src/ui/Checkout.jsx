                    ...
                    <tr>
                      ...
                      <td style={{ width: "600px" }}>
                        <p style={{ fontSize: "14px" }}>
                          <b>100 off</b> Lorem ipsum dolor sit amet consectetur
                          adipisicing elit. Eum, voluptates inventore ea
                          asperiores quo dicta!
                          <br />
                          <button
                ...
                <table className="table table-light">
                  <tbody>
                    ...
                    <tr>
                      <td>Total Amount</td>
                      <td>
                        <b>{turf.price * timingSlotArr.length}.00</b>
                      </td>
                    </tr>
                    <tr>
                      <td>Discount</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <b>{turf.price * timingSlotArr.length - discount}.00</b>
                      </td>
                    </tr>
                    <tr>
                      <td colSpan="2">
                        ...
                        <button
                          onClick={() =>
                            handleStripePayment(
                              turf.price * timingSlotArr.length - discount,
                            )
                          }
