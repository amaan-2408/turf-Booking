        ...
        <div className="container">                                                                                                                                                           
          ...
          >                                                                                                                                                                                   
            ...
            <section style={{ marginBottom: 'var(--space-6)' }}>                                                                                                                              
              ...
              >                                                                                                                                                                               
                <i className="fa fa-map-marker-alt me-2"></i>Location &amp; contact                                                                                                           
              </h2>                                                                                                                                                                           
            ...
            <section style={{ marginBottom: 'var(--space-4)' }}>                                                                                                                              
              ...
              <div className="row g-3">                                                                                                                                                       
                ...
                <div className="col-md-6">                                                                                                                                                    
                  ...
                  {AddTurfFrm.errors.time_open && AddTurfFrm.touched.time_open && (                                                                                                           
                    <small className="text-danger">                                                                                                                                           
                      {AddTurfFrm.errors.time_open}                                                                                                                                           
                    </small>                                                                                                                                                                  
                  )}                                                                                                                                                                          
                                                                                                                                                                                              
                  <label htmlFor="turf-close" className="form-label" style={{ marginTop: 'var(--space-3)' }}>                                                                                 
                    Closes at                                                                                                                                                                 
                  </label>                                                                                                                                                                    
                  <select                                                                                                                                                                     
                    id="turf-close"                                                                                                                                                           
                  ...
                  {AddTurfFrm.errors.time_close && AddTurfFrm.touched.time_close && (                                                                                                         
                    <small className="text-danger">                                                                                                                                           
